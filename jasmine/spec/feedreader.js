    ...
    */
    describe('RSS Feeds', function() {
        ...
        it("have a valid URL", function(){
            ...
            // regular expression from http://urlregex.com/
            function is_url(str){
                urlValidation =  /((([A-Za-z]{3,9}:(?:\/\/)?)(?:[\-;:&=\+\$,\w]+@)?[A-Za-z0-9\.\-]+|(?:www\.|[\-;:&=\+\$,\w]+@)[A-Za-z0-9\.\-]+)((?:\/[\+~%\/\.\w\-_]*)?\??(?:[\-\+=&;%@\.\w_]*)#?(?:[\.\!\/\\\w]*))?)/;
                return (urlValidation.test(str) ? true : false);
            }
        ...
        it("have a valid name", function(){
            for (let feed of allFeeds){
                ...
                expect(feed.name.replace(/ /g,'').length).toBeGreaterThan(0);
            }
        });
    });
    ...
    describe("Initial Entries", function (){
        ...
        it("have at least a single element in the feed container", function(done){
    ...
    describe("New Feed Selection", function(){
        ...
        it("when new feed is loaded, the content changes", function(done){
            expect(currentFeed === newFeed).toBe(false);
